...
const assesment = () => {
  if (assesmentValue === '0') {
    ...
    return 'This looks like it could be a nevus: Nevus (plural: nevi) is the medical term for a mole. Nevi are very common. Most peopleTrusted Source have between 10 and 40. Common nevi are harmless collections of colored cells. They typically appear as small brown, tan, or pink spots.
